...
class DashboardPage(QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.val_wall = add_metric(3, "WALL", "UNKNOWN")
        self.val_drill = add_metric(4, "DRILL", "EQUIPPED")
        self.val_target = add_metric(5, "TARGET", "SEARCHING")
        self.val_iteration = add_metric(6, "ITERATION", "0 / 3")
        self.val_rock = add_metric(7, "ROCK", "SEARCHING")
        self.val_spider = add_metric(8, "SPIDER", "NONE")
        self.val_battery = add_metric(9, "BATTERY", "OK")
        self.val_location = add_metric(10, "MINE", "INSIDE")
        self.val_state = add_metric(11, "STATE", "IDLE")
        self.val_conf = add_metric(12, "CONFIDENCE", "0%")
        self.val_perc_fps = add_metric(13, "PERC FPS", "0.0")
        self.val_proc_time = add_metric(14, "PROC TIME", "0 ms")
        self.val_dropped = add_metric(15, "DROPPED", "0 (0.0%)")
    ...
    def update_perception_display(
        ...
        drill_text = p.status.drill_state.name.replace("_", " ").upper() if hasattr(p.status.drill_state, "name") else str(p.status.drill_state.value)
        self._set_val(self.val_drill, drill_text)
