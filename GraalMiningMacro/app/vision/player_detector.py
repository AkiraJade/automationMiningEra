    ...
    def detect(
        ...
        if reference_manager is not None and has_player_refs:
            ...
            if self._last_center is not None:
                ...
                track_scales = [self._locked_scale, 1.0, 1.05, 0.95] if abs(self._locked_scale - 1.0) > 1e-3 else [1.0, 1.05, 0.95]
